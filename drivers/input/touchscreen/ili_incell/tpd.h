...
#define TPD_DEVICE            "mtk-tpd-core"
#define TPD_X                  0
#define TPD_Y                  1
#define TPD_Z1                 2
#define TPD_Z2                 3
...
extern int ili988x_driver_init(void);
extern void ili988x_driver_exit(void);
extern int ft8006_driver_init(void);
extern void ft8006_driver_exit(void);
